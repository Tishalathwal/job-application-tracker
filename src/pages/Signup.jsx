...
import { saveUserProfile } from '../firebase/applications';
...
export default function Signup() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      await saveUserProfile(userCredential.user.uid, { fullName, email });
      navigate('/dashboard');
    } catch (err) {
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-50 via-teal-50 to-cyan-50 px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 mt-2">Start tracking your job applications today</p>
        </div>
